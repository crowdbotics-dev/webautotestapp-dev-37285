...
## Project Structure
    ...
    ├── webautotestapp_dev_37285  # Django project configurations
...
1. Clone this repo and `cd webautotestapp_dev_37285`
...
2. Clone this repo and `cd webautotestapp_dev_37285`
